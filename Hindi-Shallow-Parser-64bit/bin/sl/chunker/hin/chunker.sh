...
$SHALLOW_PARSER_HIN/bin/sl/CRF++-0.51/crf_test -m $SHALLOW_PARSER_HIN/data_bin/sl/chunker/hin/240k_model_chunker /tmp/chunkinput_pos$$.tnt > /tmp/chunker_out$$.tnt
