...
$SHALLOW_PARSER_HIN/bin/sl/CRF++-0.51/crf_test -m $SHALLOW_PARSER_HIN/data_bin/sl/postagger/hin/240k_model_postagger /tmp/posextra_input$$.tmp > /tmp/poscrfout$$.tmp
