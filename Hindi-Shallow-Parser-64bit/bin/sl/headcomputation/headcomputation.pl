...
if($help eq 1)
{
	print "Head Computation  - Head Computation Version 1.7\n(30th May 2009)\n\n";
	print "usage : ./run-headCompute.pl --path=/home/headComputation-1.7 [-i inputfile|--input=\"input_file\"] [-o outputfile|--output=\"output_file\"] \n";
