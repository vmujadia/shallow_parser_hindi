...
# Tokenizer
sh $SHALLOW_PARSER_HIN/bin/sl/tokenizer/tokenizer_run.sh $1 > $2/tokenizer.tmp
...
# Morph Analyzer
sh $SHALLOW_PARSER_HIN/bin/sl/morph/hin/morph_run.sh $2/tokenizer.tmp > $2/morph.tmp
# POS Tagger
...
# Pickone Morph
sh $SHALLOW_PARSER_HIN/bin/sl/pickonemorph/pickonemorph.sh $2/pruning.tmp > $2/pickonemorph.tmp
# Head Computation
